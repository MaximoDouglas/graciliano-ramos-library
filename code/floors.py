...
class Floor:
    ...
    def __init__(self, reference=None):
        ...
        self.sub_part_half_depth = [10, 8, 8, 8]
    ...
    def __get_sub_part_center(self, reference):
        sub_part_center = [
                        (reference[0] + 0, reference[1] - 0.1, reference[2] + 0),
                        (reference[0] + 0, reference[1] + 3.9, reference[2] + 0),
                        (reference[0] + 0, reference[1] + 6.9, reference[2] + 0),
                        (reference[0] + 0, reference[1] + 9.9, reference[2] + 0)
                        ]
    ...
    def __generate_coordinates(self):
        ...
        # For loop to generate all the coordinates of the floor parts
        ...
        for i in range(len(self.sub_part_half_height)):
            ...
            # This vector stores the vertices of the front face of the sub_part part of the floor
            sub_part_front = (a,b,c,d)
            sub_part.append(sub_part_front)

            # This vector stores the vertices of the sub_part face of the sub_part part of the floor
            sub_part_back = (e,f,g,h)
            sub_part.append(sub_part_back)

            # This vector stores the vertices of the right face of the sub_part part of the floor
            sub_part_right = (b,f,g,c)
            sub_part.append(sub_part_right)

            # This vector stores the vertices of the left face of the sub_part part of the floor
            sub_part_left = (e,a,d,h)
            sub_part.append(sub_part_left)

            # This vector stores the vertices of the top face of the sub_part part of the floor
            sub_part_top = (c,g,h,d)
            sub_part.append(sub_part_top)

            # This vector stores the vertices of the bottom face of the sub_part part of the floor
            sub_part_bottom = (a,e,f,b)
            sub_part.append(sub_part_bottom)

            self.floor.append(sub_part)
