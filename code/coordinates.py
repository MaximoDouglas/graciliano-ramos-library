...
class Coordinates():
    ...
    c_coordsT = [(-5.5,0,9.3),
                ...
                (-4.7, 0, -15), (-0.7, 0, -15), (3.3, 0, -15), (-2.7, 0, -12), (1.3, 0, -12), (-6.2, 0, -1), # 90 degrees
    ...
    cbc_coordsT = [(3.5,0,3), (3.5,4,3), (-6.6, 0, -6.5), (-6.6, 0, -9.5),
                    (-6.6, 0, -12.5), (-6.6, 0, -15.5), (6.6, 0, -6.5), (6.6, 0, 15.5),
                    (6.6, 0, 12.5), (6.6, 0, 9.5), (6.6, 0, 6.5), (6.6, 0, -9.5), (6.6, 0, -12.5),
                    (-6.5, 0, 6.5), (-6.5, 0, 3.7),
